...
class TestStationClassifierArtefactsAreBaked:
    ...
    def test_the_backbone_head_and_card_are_all_fetched_at_build_time(self):
        ...
        for artefact in (
            "dinov2-base.onnx",
            "station-head-hala-prawe-v1-v3.0.0.onnx",
            "station-head-hala-prawe-v1-v3.0.0.card.json",
        ):
    ...
    def test_the_station_paths_are_exposed_as_env_defaults(self):
        ...
        assert "STATION_HEAD_PATH=/app/models/station-head-hala-prawe-v1-v3.0.0.onnx" in dockerfile
        assert (
            "STATION_CARD_PATH=/app/models/station-head-hala-prawe-v1-v3.0.0.card.json"
            in dockerfile
        )
