...
Development geometries: `controlled-garden`, `factory-bending`, `factory-floor`, and
`pexels-track`. Test-only geometries: `controlled-patio` and `pexels-marathon`.
...
the same four development geometries. The 150 test samples use only `controlled-patio` and
